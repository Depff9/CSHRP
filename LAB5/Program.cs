...
namespace EducationSystem
{
    ...
    class Course
    {
        ...
        // Делегат для обработки события добавления студента
        public delegate void StudentAddedHandler(object sender, Student student);

        // Событие, которое вызывается при добавлении студента
        ...
        public void AddStudent(Student student)
        {
            if (Students.Count < Capacity)
            {
                ...
                // Вызов события при добавлении студента
    ...
    class Program
    {
        ...
        static void Main()
        {
            // Подписываемся на событие добавления студента
        ...
        static void Course_StudentAdded(object sender, Student student)
        {
